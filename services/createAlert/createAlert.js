...
export function main(event, context, callback) {
  ...
  axios
    ...
    .then(response => {
      ...
      // Create new Webhook or Update existing Webhook
      ...
      let putParams = {
        ...
        Item: {
          ...
          alertSettings: { S: clientRequestData.alertSettings },
      ...
      DDB.putItem(putParams, function(err, data) {
        if (err) {
          console.log(
            "Error creating/updating alert for channelId: " + channelId
          );
          console.log(err, err.stack);
          callback(responseError);
        } else {
          console.log(
            "Successfully created/updated alert for channelId: " + channelId
          );
